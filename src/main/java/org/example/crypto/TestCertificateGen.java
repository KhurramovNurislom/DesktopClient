...
//    private  volatile long serialNumber = System.currentTimeMillis();
//    private  Map<String, AlgorithmIdentifier> algIds = new HashMap<String, AlgorithmIdentifier>();
//
//     {
...
//    }
//
//    public X509Certificate createSelfSignedCert(String dn, String sigName, KeyPair keyPair)
//            throws Exception {
//        return createSelfSignedCert(new X500Name(dn), sigName, keyPair);
//    }
//
//    public  X509Certificate createSelfSignedCert(X500Name dn, String sigName, KeyPair keyPair)
//            throws Exception {
...
//    }
//
//    public  X509Certificate createCert(X500Name signerName, PrivateKey signerKey, String dn, String sigName, Extensions extensions, PublicKey pubKey)
//            throws Exception {
//        return createCert(signerName, signerKey, new X500Name(dn), sigName, extensions, pubKey);
//    }
//
//    public  X509Certificate createCert(X500Name signerName, PrivateKey signerKey, X500Name dn, String sigName, Extensions extensions, PublicKey pubKey)
//            throws Exception {
...
//    }
//
//    public  X509Certificate createCertWithIDs(X500Name signerName, String sigName, KeyPair keyPair, boolean[] subjectUniqID, boolean[] issuerUniqID)
//            throws Exception {
//        V3TBSCertificateGenerator certGen = new V3TBSCertificateGenerator();
//
//        long time = System.currentTimeMillis();
...
//    }
//
//    public  X509Certificate generateRootCert(KeyPair pair, X500Name dn)
//            throws Exception {
...
//    }
//
//    public   X509Certificate generateIntermediateCert(PublicKey intKey, X500Name subject, PrivateKey caKey, X509Certificate caCert)
//            throws Exception {
...
//    }
//
//    public   X509Certificate generateEndEntityCert(PublicKey intKey, PrivateKey caKey, X509Certificate caCert)
//            throws Exception {
//        return generateEndEntityCert(
//                intKey, new X500Name("CN=Test End Certificate"), caKey, caCert);
//    }
//
//    public   X509Certificate generateEndEntityCert(PublicKey entityKey, X500Name subject, PrivateKey caKey, X509Certificate caCert)
//            throws Exception {
//        Certificate caCertLw = Certificate.getInstance(caCert.getEncoded());
//
//        ExtensionsGenerator extGen = new ExtensionsGenerator();
