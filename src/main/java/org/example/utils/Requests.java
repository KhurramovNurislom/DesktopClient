...
//import org.example.modules.messages.Messages;
...
//        Response response = Main.getClient().newCall(request).execute();
//
//        AUsers ausers = objectMapper.readValue(response.body().byteStream(), AUsers.class);
//
//        Main.setAUsers(ausers);
//
...
////         * */
////
////        System.out.println("link => 123 => " + link);
////
////        try {
////            Request request = new Request.Builder()
////                    .url(link)
...
//        try {
//            verification = gson.fromJson(response.body().string(), VerificationInfo.class);
//        } catch (IOException e) {
//            throw new RuntimeException(e);
//        }
//        Main.setVerification(verification);
...
// System.out.println(Main.getUrl());
    ...
    public void RequestSignLink() {
        ...
        try {
            assert response.body() != null;
            hash = objectMapper.readValue(response.body().byteStream(), Hash.class);
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
        Main.setHash(hash);
